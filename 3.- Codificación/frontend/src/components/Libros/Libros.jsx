    ...
    return (
        <div>
            ...
            <div className="container">
                <h2 className="text-center mt-5">¿ Buscas un Libro ?</h2>
                    ...
                    {isAdmin && (
                        <>
                            <div className="row mb-3 mt-3">
                                <div className="col-md-6">
                                    <button className="btn btn-primary" onClick={handleAddPermission}>Añadir Libro</button>
                                </div>
                            </div>
                        </>)}
                    {message && (
                                        ...
                                        <td>
                                            {isAdmin && (
                                                <>
                                                    ...
                                                    <button className="btn btn-danger btn-sm me-2" onClick={() => handleDeleteLibro(libro.libro_id)}>Eliminar</button>
                                                </>
                                            )}
